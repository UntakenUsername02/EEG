...
file = 'BYB_Recording_2021-09-30_13.58.20 Amani.wav'
...
tg=np.array([5,20, 30,35, 45,55,65,80,90,95,105,115,125,135,145,160,170,175, max(t)+1])
length_t=np.shape(t)
l_row_t=length_t[0]
eyesclosed=[]
eyesopen=[]
